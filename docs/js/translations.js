...
window.portfolioTranslations = {
  ...
  pt: {
    ...
    proj_microchips_title: "Microchips Firmware Archive",
    proj_microchips_desc: "<strong>Core:</strong> Repositório público de código embarcado. Destaca-se pelo desenvolvimento de firmware de baixo nível (low-level programming) em C++ para microcontroladores, otimizando o consumo de recursos de hardware e estruturando arquiteturas de controle estáveis.",
    proj_senacpp_title: "SenaCppNivelIII (CodeVault Contributor)",
  ...
  fr: {
    ...
    proj_uperc_desc: "<strong>Core :</strong> L'une de mes architectures les plus complètes et les plus vastes. Système d'information d'entreprise pour la gestion des parkings de l'Université de Cundinamarca (Chía). Développé en Java 11, Spring MVC, Spring Data JPA, Hibernate et PostgreSQL. Points forts : Intégration d'<strong>AWS Rekognition</strong> pour l'analyse d'images et le contrôle d'accès, ainsi que le support de la localisation et de l'internationalisation.",
    proj_microchips_title: "Microchips Firmware Archive",
